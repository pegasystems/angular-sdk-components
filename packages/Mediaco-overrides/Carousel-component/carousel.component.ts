import { Component, ElementRef, ViewChildren, QueryList, AfterViewInit, OnDestroy, NgZone, Input, OnChanges, SimpleChanges, ViewChild } from '@angular/core';
...
openShowAll() {
  this.dialog.open(GalleryGridComponent, {
    // REMOVE 'panelClass' if you don't have specific global styles for it
    // panelClass: 'custom-carousel-dialog', 
    
    // 1. Set the size (Approx 50% of screen area)
    width: '60vw',   // 60% of the screen width
    height: '70vh',  // 70% of the screen height
    
    // 2. Ensure it doesn't get too big on massive screens or too small on mobile
    maxWidth: '95vw',
    maxHeight: '95vh',

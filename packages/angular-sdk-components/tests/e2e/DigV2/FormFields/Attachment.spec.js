...
test.describe('E2E test', () => {
  ...
  test('should login, create case and run the Attachment tests', async ({ page }) => {
    ...
    const cableChatFilePath = path.join(__dirname, '../../../../../angular-sdk-components/src/assets/cablechat.png');
    const cableInfoFilePath = path.join(__dirname, '../../../../../angular-sdk-components/src/assets/cableinfo.png');
    const zeroBytesFilePath = path.join(__dirname, '../../../../../angular-sdk-components/src/assets/zerobytes');

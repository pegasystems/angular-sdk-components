...
test.describe('E2E test', () => {
  test('should login, create case and run different test cases for Embedded Data', async ({ page }) => {
    ...
    let phone = page.locator('ngx-mat-input-tel[data-test-id="1f8261d17452a959e013666c5df45e07"]');
    ...
    phone = page.locator('ngx-mat-input-tel[data-test-id="1f8261d17452a959e013666c5df45e07"] >> nth=1');
    ...
    phone = page.locator('ngx-mat-input-tel[data-test-id="1f8261d17452a959e013666c5df45e07"]');
    countrySelector = phone.locator('button.country-selector');
    await countrySelector.click();
    await page.locator('div.flag.US >> nth=0').click();

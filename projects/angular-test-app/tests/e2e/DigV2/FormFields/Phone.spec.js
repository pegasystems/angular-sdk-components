...
test.describe('E2E test', () => {
  ...
  test('should login, create case and run the Phone tests', async ({ page }) => {
    ...
    await page.locator('ngx-mat-input-tel[data-test-id="af983eaa1b85b015a7654702abd0b249"] >> input').click();
    await page.locator('button:has-text("submit")').click();
    await expect(page.locator('mat-error')).toBeVisible();

    const requiredPhone = page.locator('ngx-mat-input-tel[data-test-id="af983eaa1b85b015a7654702abd0b249"] >> input');
    ...
    // /** Disable tests */
    const alwaysDisabledPhone = page.locator('ngx-mat-input-tel[data-test-id="d415da67e9764d6e7cdf3d993cb54f51"] >> input');
    attributes = await common.getAttributes(alwaysDisabledPhone);
    expect(attributes.includes('disabled')).toBeTruthy();

    const conditionallyDisabledPhone = page.locator('ngx-mat-input-tel[data-test-id="b6cee3728235ed1f6cef7b11ac850ea9"] >> input');
    ...
    const neverDisabledPhone = page.locator('ngx-mat-input-tel[data-test-id="b23e38f877c8a40f18507b39893a8d61"] >> input');
    ...
    const editablePhone = page.locator('ngx-mat-input-tel[data-test-id="591e127300787ad31c414b7159469b9e"]');
    ...
    await editablePhoneInput.clear();
    /** Todo: Modified this script because ngx-mat-input-tel doesn't provide blur event and fix need to be implemented in blur callback
    ...
    /** Visibility tests */
    await expect(page.locator('ngx-mat-input-tel[data-test-id="6637b718c18a1fd292d28b6abaa68d50"] >> input')).toBeVisible();
    ...
    const conditionallyVisiblePhone = await page.locator('ngx-mat-input-tel[data-test-id="ad9995a1b5001e6d153d363465371528"] >> input');
